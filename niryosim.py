import sim
from niryorobot import NiryoRobot


class NiryoSim(NiryoRobot):
    ...
    def closeGripper(self):
        emptyBuff = bytearray()
        #self.mov_gripper(0, 45)
        a = sim.simxCallScriptFunction(clientID=self.client_id, scriptDescription= 'NiryoOne', 
                                       options= sim.sim_scripttype_childscript, functionName= 'close', 
                                       inputInts=[], inputFloats=[], inputStrings=[], inputBuffer=emptyBuff, 
    ...
    def openGripper(self):
        ...
        #self.mov_gripper(0, 45)
        a = sim.simxCallScriptFunction(clientID=self.client_id, scriptDescription= 'NiryoOne', 
                                       options= sim.sim_scripttype_childscript, functionName= 'open', 
                                       inputInts=[], inputFloats=[], inputStrings=[], inputBuffer=emptyBuff, 
                                       operationMode=sim.simx_opmode_blocking)
    ...
    def getJoints(self):
        ...
        jl_position = self.JL.pos
        jr_position = self.JR.pos
    ...
    def get_JointState(self):
        ...
        joints_ang_position = [self.J1.rel_pos, self.J2.rel_pos, self.J3.rel_pos, self.J4.rel_pos, self.J5.rel_pos,
                               self.J6.rel_pos]
